# AI Kurikulum Koding & AI Web Application (v1.0.0)
...
[![Release](https://img.shields.io/badge/Release-v1.0.0-emerald?style=for-the-badge&logo=github)](https://github.com/sodikinnaa/coding-agent-web/releases/tag/v1.0.0)
...
## ⚡ Install Cepat via `curl` (One-Line Installer)

Jalankan perintah satu baris berikut di server Linux Anda untuk mengunduh, mengompilasi, dan mengaktifkan service secara otomatis:
...
Aplikasi ini dilengkapi dengan paket pengujian unit internal (`internal/auth`, `internal/db`, `internal/service`) dengan rating **100% PASS**:
